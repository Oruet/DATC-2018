...
public class TempGraphActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datesenzor.addAll(DateSenzori.datesenzortemp(drpelement));
        ...
        for (String element : datesenzor) {
            i++;
           // aux.add(Float.valueOf(element.substring(24, 25)));
            series.appendData(new DataPoint(i, Float.valueOf(element.substring(24, 26))), true, datesenzor.size());
